...
class SupplyChainModelHiGHS:
    def __init__(self, data):
        self.data = data
        self.solver = pywraplp.Solver.CreateSolver('HIGHS')
        if not self.solver:
            raise Exception("HiGHS backend not found.")
...
'''
    ...
    def set_objective(self):
        ...
        # 4. In-Transit Holding Cost (Phí tồn kho trên đường) <--- MỚI THÊM
...
if __name__ == "__main__":
    model = SupplyChainModelHiGHS(SupplyChainData())
